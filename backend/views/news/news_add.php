...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs10">
        ...
        <div class="layui-input-block">
            <input type="text" name="News[new_title]" class="layui-input" lay-verify="required" placeholder="请输入新闻标题">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs10">
        <label class="layui-form-label">关键词</label>
        <div class="layui-input-block">
            <input type="text" name="News[new_keywords]" class="layui-input" lay-verify="required" placeholder="请输入新闻关键词">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs10">
        <label class="layui-form-label">描述</label>
        <div class="layui-input-block">
            <textarea class="layui-textarea" name="News[new_descriptions]" lay-verify="required" ></textarea>
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label">新闻内容</label>
        <div class="layui-input-block">
            <?=common\widgets\ueditor\Ueditor::widget(['options'=>['lang' =>'zh-cn','initialFrameWidth' => 850,'initialFrameHeight' => 450],'id'=>'News[new_content]'])?>
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs6">
        <label class="layui-form-label">发布时间</label>
        <div class="layui-input-block">
            <input type="text"  name="News[new_time]" id="new_time" class="layui-input " style="width: 50%" lay-verify="required" placeholder="请选择时间">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs6">
        <label class="layui-form-label">阅读量</label>
        <div class="layui-input-block">
            <input type="text" name="News[new_number]" class="layui-input" style="width: 50%" lay-verify="amount" placeholder="请输入阅读量(整数)">
        </div>
        <div style="margin-left: 110px;margin-top: 5px">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="News[new_state]" lay-skin="switch"  lay-text="已发|未发" checked>
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs6">
        <div class="layui-input-block">
