...
var cookieDomain = "http://www.a50.hk";
...
{
	var now=document.getElementById("translateLinknow");
	now.innerHTML="<span  class='t'></span>繁體中文";
	var str = '';
	var ss = JTPYStr();
	var tt = FTPYStr();
...
function Simplized(cc){
	var now=document.getElementById("translateLinknow");
	now.innerHTML="<span  class='s'></span>简体中文";
	var str = '';
	var ss = JTPYStr();
	var tt = FTPYStr();
